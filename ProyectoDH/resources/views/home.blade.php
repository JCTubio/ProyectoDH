...
<html lang="{{ app()->getLocale() }}">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <div class="log-reg">
          <a class="navbar-brand js-scroll-trigger" href="{{ route('login') }}">Sign in</a>
          <a class="navbar-brand js-scroll-trigger" href="#navbarResponsive"> | </a>
          <a class="navbar-brand js-scroll-trigger" href="{{ route('register') }}">Sign up</a>
        </div>
